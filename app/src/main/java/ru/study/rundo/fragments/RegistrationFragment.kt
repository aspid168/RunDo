...
class RegistrationFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        registrationButton.setOnClickListener {
            ...
            if (emailValidCheck(emailText) && passwordsMatchCheck(passwordText, repeatPasswordText)) {
                val workWithServer = WorkWithServer(requireContext())
                workWithServer.addListenerRegistration(object : Handler<TokenInfo> {
    ...
    private fun showErrorInvalidEmail() {
